// Extended icon set for the dashboard (supplements the landing page Icons)
// Re-exports everything from ui/Icons plus adds dashboard-specific ones

export { Icons } from "@/components/ui/Icons";

// Additional dashboard-specific icons
export const DashIcons = {
  BarChart2: ({ s = 18, c = "currentColor" }) => (
  ...
  AlertTriangle: ({ s = 18, c = "currentColor" }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
