export const STATS = [
  ...
  { num: 9, suffix: "", label: "Analytics Panels" },
...
export const FAQ_ITEMS = [
  ...
  { q: "How much does it cost?", a: "StatTrak is completely free. All 47+ metrics, AI coaching, growth trends, risk profiles — everything is available at no cost. No credit card required." },
  { q: "Can I use StatTrak for team practice?", a: "Yes. Upload scrim demos and get coordinated feedback for your entire roster. Team analytics features are being expanded." },
];
